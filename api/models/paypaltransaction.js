  ...
  const PaypalTransaction = sequelize.define('PaypalTransaction', {
    ...
    classMethods: {
      associate: function(models) {
        ...
        models.PaypalTransaction.sender = models.PaypalTransaction.belongsTo(models.User, {as: 'Sender'});
        models.PaypalTransaction.receiver = models.PaypalTransaction.belongsTo(models.User, {as: 'Receiver'});
      }
    }
  });
